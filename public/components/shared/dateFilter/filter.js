...
export default angular.module('app.shared.filter', [EventingModule.name])
  .controller('DateFilterController', ['EventEmitter', 'DateFilterService', DateFilterController])
  .service('DateFilterService', ['$aside', DateFilterService]);
